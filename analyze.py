...
def analysis_file_creation(graph, datetime_name, log_file):
    ...
    analysis_file.write("Perplexity Standard Deviation: " + str(pd.Series(perplexity_list).std()) + "\n")
    analysis_file.write("Perplexity Median: " + str(pd.Series(perplexity_list).median()) + "\n")
    analysis_file.write("Perplexity Mode: " + str(pd.Series(perplexity_list).mode()) + "\n")
    analysis_file.write("Perplexity List: " + str(perplexity_list) + "\n")
